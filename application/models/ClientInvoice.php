...
class Model_ClientInvoice {
  ...
  private $_storage_name = 'client_invoice_list';
  private $_next_id = 0;
  ...
  public function getAllByClientId($client_id) {
    $invoice_list = Model_Operation_Array::mapByParam($this->_entries, 'client_id', true, true);

    return isset($invoice_list[$client_id]) ? $invoice_list[$client_id] : array();
  }
