...
class Model_Helper_Encoding {
   ...
   * @return string
   */
  public static function simpleHexEncodingWithStrRot13($token){
    return str_rot13(bin2hex($token));
  }
   ...
   * @return string
   */
  public static function simpleHexDecodingWithStrRot13($token){
    return pack("H*",str_rot13($token));
  }
