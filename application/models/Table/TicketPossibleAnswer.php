...
/**
 * Model_Table_TicketPossibleAnswer
 *
 * Access Model_Table_TicketPossibleAnswer - internal functions
 *
 * @author Robert
 */
class Model_Table_TicketPossibleAnswer extends Zend_Db_Table_Abstract
{

    protected $_name = 'ticket_possible_answer';
